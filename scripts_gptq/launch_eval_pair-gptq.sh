...
#list of strings to evaluate
LANG_PAIRS=("hf://datasets/haoranxu/WMT22-Test/en-ru/test-00000-of-00001-889b8af39e8c83c4.parquet")
...
do
    ...
    sbatch --job-name "eval-${LANG}" eval_pairs.job --src "${SRC_LANG}" --data_path "${LANG_PAIR}" --tgt "${TGT_LANG}" --dtype "float16" --model /home/scur1753/gptq/ALMA-7B_checkpoint_4bits-getalma-gptq.pt --beam 5 --gptq True
done